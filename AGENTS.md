...
| `apps/api` | **Built through Milestone 08.** 527 tests. NestJS, Prisma, Redis, BullMQ, Pino, Terminus. `/health` checks database, redis, queue **and exchange connectivity**. |
...
| Signal · Confidence · Calibration engines | **Not built.** Approved trades are produced and **nothing publishes them yet.** |
