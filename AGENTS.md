...
| `apps/api` | **Built through Milestone 13.** 635 tests. NestJS, Prisma, Redis, BullMQ, Pino, Terminus. `/health` checks database, redis, queue **and exchange connectivity**. |
...
3. **Settings · Admin** — later milestones. (Notifications is now LIVE — M13.)
